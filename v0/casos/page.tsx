...
const casosIniciales = [
  { id: "1", nombre: "Caso Audiencia 2024-001", fechaCreacion: "2024-01-15", audios: 5, transcripciones: 3 },
  { id: "2", nombre: "Entrevista Cliente García", fechaCreacion: "2024-01-18", audios: 2, transcripciones: 2 },
  { id: "3", nombre: "Declaración Testigo A", fechaCreacion: "2024-01-20", audios: 1, transcripciones: 1 },
  { id: "4", nombre: "Caso Penal 2024-045", fechaCreacion: "2024-01-22", audios: 8, transcripciones: 6 },
  { id: "5", nombre: "Mediación Familiar López", fechaCreacion: "2024-01-25", audios: 3, transcripciones: 3 },
]
                ...
                <Link href={`/casos/${caso.id}`} className="flex flex-1 items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
                      ...
                      <span className="hidden sm:inline">{caso.audios} audios</span>
                      <span className="hidden sm:inline">•</span>
                      <span className="hidden sm:inline">{caso.transcripciones} transcripciones</span>
                    </div>
                  </div>
                </Link>
